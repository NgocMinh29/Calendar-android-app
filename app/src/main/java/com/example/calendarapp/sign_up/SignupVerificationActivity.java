...
public class SignupVerificationActivity extends AppCompatActivity {
    ...
    private void handleVerificationCodeResponse(String responseStr) {
        try {
            ...
            // Check if test_code is included in the response
            if (jsonResponse.has("test_code")) {
                final String testCode = jsonResponse.getString("test_code");

                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        // Display the code in a Toast for testing purposes
                        Toast.makeText(SignupVerificationActivity.this,
                                "Test code: " + testCode + "\n" + message, Toast.LENGTH_LONG).show();

                        // Optionally, auto-fill the verification code fields
//                        if (testCode.length() >= 6) {
//                            digit1.setText(String.valueOf(testCode.charAt(0)));
//                            digit2.setText(String.valueOf(testCode.charAt(1)));
//                            digit3.setText(String.valueOf(testCode.charAt(2)));
//                            digit4.setText(String.valueOf(testCode.charAt(3)));
//                            digit5.setText(String.valueOf(testCode.charAt(4)));
//                            digit6.setText(String.valueOf(testCode.charAt(5)));
//                        }
                    }
                });
            }
